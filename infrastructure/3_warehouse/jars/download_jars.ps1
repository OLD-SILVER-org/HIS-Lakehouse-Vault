...
$Jars = @(
    ...
    #Elastic Search
    @{ name = "elasticsearch-spark-30_2.12-8.13.4.jar"; url = "https://repo1.maven.org/maven2/org/elasticsearch/elasticsearch-spark-30_2.12/8.13.4/elasticsearch-spark-30_2.12-8.13.4.jar"}
)
...
Write-Host "`nDownload complete! All $($Jars.Count) JAR files are ready for Warehouse layer." -ForegroundColor Green

...
/**
 * Flink batch job to process all 'dm_*' and 'ct_*' tables for initial data ingestion.
 */
public class HospitalBatchJob extends AbstractBatchBase {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Starting Combined Hospital Flink Batch Job for DM and CT tables...");
        HospitalBatchJob job = new HospitalBatchJob();
        job.run();
    }
}
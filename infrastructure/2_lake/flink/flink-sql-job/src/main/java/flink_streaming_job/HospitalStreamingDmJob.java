...
/**
 * Flink streaming job to process all 'dm_*' (dictionary/master) related tables.
 */
public class HospitalStreamingDmJob extends AbstractStreamingBase {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Starting Hospital Flink Streaming Job for DM (Dictionary/Master) tables...");
        HospitalStreamingDmJob job = new HospitalStreamingDmJob();
        job.run();
    }
}